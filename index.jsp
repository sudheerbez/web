		...
		<div id="featured">
			<ul>
				<li class="first">
					...
					<div><span></span><a href="index.html"><img src="images/themes.jpg" alt="Image"/></a></div>
		...
		<div>
			...
			<div id="section">
				<div id="article">
					...
					<ul>
						<li class="first">
							<h2><a href="index.html">This is just a place holder, so you can see what the site would look like.</a></h2>
							...
							<div>
								<a href="index.html">Sept 21, by Nullam</a>
								<span class="separator">|</span>
								<a href="index.html">99 Views</a>
								<span class="separator">|</span>
								<a href="index.html">69 Comments</a>
							</div>
						</li>
						<li>
							<h2><a href="index.html">This is just a place holder, so you can see what the site would look like.</h2>
							<a href="index.html"><img src="images/img-03.jpg" alt="Image"/></a>
				...
				<div id="news">
					...
					<ul>
						<li class="first">
							...
							<div><a href="index.html">Sept 21, by Nullam</a></div>
						</li>
						<li>
				...
				<div id="contact">
					...
					<table>
						...
						<tr>
							<td>connect</td>
							<td>:</td>
							<td><a href="http://twitter.com/fwtemplates" class="twitter">Twitter</a><a href="http://facebook.com/freewebsitetemplates" class="facebook">Facebook</a></td>
						</tr>
					</table>
				</div>
			</div>
